...
Do you want disclose a potential security issue for Apache Fory? You can read more about the projects' security policy on their [security page](https://fory.apache.org/security/), and email your report to the [Apache Security Team](mailto:security@apache.org).
