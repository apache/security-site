...
Do you want disclose a potential security issue for Apache Superset? You can read more about the projects' security policy on their [security page](https://github.com/apache/superset/blob/master/.github/SECURITY.md), and email your report to the [Apache Security Team](mailto:security@apache.org).
