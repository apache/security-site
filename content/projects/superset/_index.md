...
This page is experimental: it provides consistent access to the advisories for Apache Superset since 2023 in text and CVE JSON format. It may lag slighly behind the official CVE publications. 
